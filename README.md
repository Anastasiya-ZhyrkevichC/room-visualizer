...
- `npm run prices:update` recalculates all starter cabinet prices from the manual pricing config, including edging, and refreshes `config/cabinet-pricing.generated.json` with compact per-variant pricing steps.
